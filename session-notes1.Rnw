...
plot=ggplot(q1) +geom_point(aes_string(x="number",y="R")) + 
  ...
  theme_bw()+opts(title="R bar chart")+ylim(0,9) 
print(plot)
@ 
...
plot=ggplot(q1) +geom_point(aes_string(x="number",y="xBar")) + 
  ...
  geom_hline(aes(yintercept=14.36))+ geom_hline(aes(yintercept=25.34))+
  geom_hline(aes(yintercept=19.85)) +
  theme_bw()+opts(title="X double bar chart") +ylim(5,30)
print(plot)
@ 
